"""
Script to add pottery/workshop images to workshops from Unsplash
Run with: python manage.py shell < add_workshop_images.py
"""
...
workshop_images = {
    ...
    'couple': [
        'https://images.unsplash.com/photo-1594069255016-c43949a25b5e<br>?w=800&q=80',  # Couple pottery
...
print(f"Found {workshops.count()} workshops")
...
for idx, workshop in enumerate(workshops):
    ...
    print(f"✓ Updated {workshop.name} ({workshop.workshop_type}) with image")
